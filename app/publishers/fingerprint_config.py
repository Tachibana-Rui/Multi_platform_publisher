...
DEVICE_PRESETS = {
    ...
    # ---- Microsoft Edge（Chromium 内核，Windows 桌面）----
    "desktop_edge_1080p": {
        "profile": "desktop_edge_1080p",
        "platform": "Win32",
        "vendor": "Google Inc.",
        "screen_width": 1920,
        "screen_height": 1080,
        ...
        "languages": ["zh-CN", "zh", "en-US", "en"],
        "language": "zh-CN",
        "accept_languages": "zh-CN,zh;q=0.9,en;q=0.8,en-US;q=0.7",
        "locale_country_code": "CN",
        "webgl_vendor": "Google Inc. (Microsoft)",
        "webgl_renderer": "ANGLE (Microsoft, Intel(R) UHD Graphics 630 Direct3D11 vs_5_0 ps_5_0, D3D11)",
    },
    # ---- macOS Safari ----
    "desktop_safari_sonoma": {
        "profile": "desktop_safari_sonoma",
        "platform": "MacIntel",
        "vendor": "Apple Computer, Inc.",
        "screen_width": 1440,
        "screen_height": 900,
        ...
        "languages": ["zh-CN", "zh-Hans", "en-US", "en"],
        "language": "zh-CN",
        "accept_languages": "zh-CN,zh-Hans;q=0.9,en-US;q=0.7,en;q=0.3",
        "locale_country_code": "CN",
        "webgl_vendor": "Apple Inc.",
